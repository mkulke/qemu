...
static int create_partition(int mshv_fd, int *vm_fd)
{
    ...
    /* disable all, then enable known-to-be-supported xsave features */
    disabled_xsave_features.as_uint64 = UINT64_MAX;
    disabled_xsave_features.avx_support = 0;
    disabled_xsave_features.xsave_comp_support = 0;
    disabled_xsave_features.xsave_supervisor_support = 0;
    disabled_xsave_features.xsave_support = 0;
    disabled_xsave_features.xsaveopt_support = 0;
