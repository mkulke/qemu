...
union hv_partition_processor_features {
	...
	struct {
		...
		uint64_t btc_no_support:1; // AMD branch confusion no support
		...
		uint64_t gds_no_support:1; // If machine is vulnerable to GDS.
		...
		uint64_t rfds_no_support:1; // If machine is vulnerable to RFDS.
